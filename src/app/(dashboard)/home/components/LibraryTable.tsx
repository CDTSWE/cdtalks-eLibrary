...
const LibraryTable = ({ books }: { books: BookType[] }) => {
  ...
  // Variable to show the filtered & searched books
  const filteredSearchedBooks = useMemo(() => {}, [])
    ...
    <>
      <Card>
        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          ...
          <CustomTextField id='search-field' placeholder='Search books...' />

          <div className='flex flex-wrap items-center gap-4'>
            {/* Implement the show rows of data here! */}
            <CustomTextField id='showRows-field' select className='flex-auto is-[70px]'>
              <MenuItem value='5'>5</MenuItem>
              <MenuItem value='10'>10</MenuItem>
              <MenuItem value='15'>15</MenuItem>
            </CustomTextField>

            {/* Implement the filter by genre here! */}
            <CustomTextField id='filter-field' select className='flex-auto is-[150px]'>
